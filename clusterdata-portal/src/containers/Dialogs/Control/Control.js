...
class Control extends React.PureComponent {
    ...
    onApply = () => {
        const {control, dataset, external, defaults, availableItems, showTitle, sourceType, title, isExpandedFilter} = this.state;
        const field = dataset.fieldId || control.fieldName;

        const selectValue = (controlValue, propsValue) => controlValue === null || controlValue === undefined ?
    ...
    renderElementSwitchers() {
        ...
        const {elementType, acceptableValues, defaultValue, availableValues, multiselectable, nullable, isRange} = control;
