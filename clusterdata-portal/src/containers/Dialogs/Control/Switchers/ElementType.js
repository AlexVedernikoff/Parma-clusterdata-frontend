...
const ITEMS = [
    {value: ELEMENT_TYPE.SELECT, get title() { return i18n('dash.control-dialog.edit', 'value_element-select'); }},
    {value: ELEMENT_TYPE.DATE, get title() { return i18n('dash.control-dialog.edit', 'value_element-date'); }},
    {value: ELEMENT_TYPE.INPUT, get title() { return i18n('dash.control-dialog.edit', 'value_element-input'); }}
];
