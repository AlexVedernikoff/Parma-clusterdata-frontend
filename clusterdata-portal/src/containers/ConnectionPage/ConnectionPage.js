...
class ConnectionPage extends React.Component {
            ...
            <Button
                ...
                text={
                    connectionId && !permissionsSelectVisible
                        ? !isStateChanged && isChangesSaved && !isActionProgress ? i18n('button_already-saved') : i18n('button_save')
                        : i18n('button_create')
                }
    ...
    _renderErrorContent() {
        ...
        const {
            ...
            description,
            action
        } = this._getErrorMessageByCode({status, data});
