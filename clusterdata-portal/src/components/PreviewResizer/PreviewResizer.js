...
class PreviewResizer extends React.Component {
    ...
    setDatasetBottomOffset = () => {
        ...
        if (view === this.RIGHT_VIEW) {
            ...
            const datasetHeight = tableDatasetHeight
                + parseInt(this.tableDataset.style.marginBottom || 0, 10);
    ...
    correctPreviewSize = (e) => {
        ...
        switch (view) {
            ...
            case this.RIGHT_VIEW: {
                ...
                this.resizableElement.style.height = `${
                    innerHeight - this.headerHeight - this.actionPanelHeight - this.datasetActionPanelHeight
                }px`;
                break;
            }
            default: {
