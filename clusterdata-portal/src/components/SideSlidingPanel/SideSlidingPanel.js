...
function SideSlidingPanel({title = '', footerContent, isOpen = false, onCloseAction = () => {}, styleMods, children}) {
        ...
        <React.Fragment>
            <div className={b({view: isOpen ? 'open' : 'close', ...styleMods})}>
                <div className={b('header')}>
                    ...
                    >
                        <ButtonIcon><Icon data={closeBig} width="22" height="22" /></ButtonIcon>
                    </ Button>
                </div>
