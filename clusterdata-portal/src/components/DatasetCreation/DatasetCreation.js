          ...
          {this.isDisplaySection({
            ...
            <div className={b('warning-yt')}>
              ...
              <ol>
                ...
                <li>
                  Открыта на чтение роботу <UserName inline>@robot-clusterdata</UserName>
                </li>
                <li>Размер (uncompressed size) таблицы не должен превышать 1ГБ</li>
              </ol>
              <span>
                В текущей реализации Статистика ходит за данными от имени <UserName inline>@robot-clusterdata</UserName>
