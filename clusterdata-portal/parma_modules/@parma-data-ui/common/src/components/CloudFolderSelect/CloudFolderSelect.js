...
class CloudFolderSelect extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        const isOpenPopup = this.state.popupVisible &&
    ...
    get currentCloudItem() {
        return this.preparedCloudList.find(({cloudId}) =>
    ...
    get currentFolderItem() {
        ...
        return this.preparedCloudList.find(({cloudId, folderId}) =>
    ...
    renderCurrentCloudFolder = () => {
        ...
        return (
            <React.Fragment>
                {item.folderId === undefined ? this.renderIcon({type: 'cloud'}) : (
    ...
    renderList() {
        ...
        return data.length === 0 ? (
            <div className={b('popup-empty')}>
                ...
                <span className={b('popup-empty-text')}>
                    {this.props.textEmptyListMessage}
                </span>
            </div>
        ) : (
