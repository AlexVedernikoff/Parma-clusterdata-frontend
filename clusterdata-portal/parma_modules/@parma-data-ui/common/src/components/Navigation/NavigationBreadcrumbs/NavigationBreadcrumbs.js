...
import {NAVIGATION_ROOT, NAVIGATION_FAVORITES, NAVIGATION_LATEST, NAVIGATION_DASHBOARDS, NAVIGATION_DATASETS, NAVIGATION_WIDGETS, NAVIGATION_CONNECTIONS} from '../constants';
...
class Crumb extends PureComponent {
    ...
    render() {
        ...
        const node = (
            ...
            >
                <span className={b('folder-name', {last})}>
                    {item.name}
                </span>
            </div>
        );
...
class NavigationBreadcrumbs extends PureComponent {
    ...
    render() {
        return (
            <div className={b({size: this.props.size})}>
