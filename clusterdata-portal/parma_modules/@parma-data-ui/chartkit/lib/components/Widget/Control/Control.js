...
class Control extends React.PureComponent {
    ...
    get params() { return {...this.props.params, ...this.state.params}; }
    ...
    renderControl = (control) => {
        ...
        const props = {
            ...
            value: type === TYPE.RANGE_DATEPICKER ?
                {
    ...
    renderBody() {
        ...
        return (
            <React.Fragment>
                {this.state.scheme.map(this.renderControl)}
            </React.Fragment>
        );
    }
    ...
    render() {
        return (
            <div className={b({standalone: this.props.standalone})}>
                {this.renderBody()}
            </div>
        );
    }
