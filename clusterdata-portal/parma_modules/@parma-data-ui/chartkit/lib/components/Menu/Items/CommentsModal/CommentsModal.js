...
export default class CommentsModal extends React.PureComponent {
    ...
    _close(event) {
        const comments = this.state.excludeParams ?
            ...
            this.state.comments.filter(({feed, params, isStat}) =>
                        ...
                        <Form
                            {...{
                                ...
                                onAction: (newComment, isEdited) => {
                                    ...
                                    const isMatchedWithCommentsConfig =
                                        this.props.checkMatchCommentsConfig(newComment.feed, newComment.params);
                                ...
                                ref: (component) => { this._formComponent = component; }
                            }}
                        />
                    </ChartsModal.Body>
                </ChartsModal.Section>
