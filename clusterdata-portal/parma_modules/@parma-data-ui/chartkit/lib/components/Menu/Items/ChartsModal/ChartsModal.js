...
ChartsModal.Section = (props) => (
    <div className={b('section', props.mix)}>
        {props.children}
    </div>
);
ChartsModal.Section.propTypes = {
    children: (props, propName) => {
        React.Children.forEach(props[propName], (child) => {
            if (child.type !== ChartsModal.Body
...
ChartsModal.Header = (props) => (
    <div className={b('header', props.mix)}>
        {props.children}
    </div>
);
...
ChartsModal.Body = (props) => (
    <div className={b('body', props.mix)}>
        {props.children}
    </div>
);
