...
extend({
    dots: <path d="M14 6.125a1.874 1.874 0 1 1 .001 3.749A1.874 1.874 0 0 1 14 6.125zm-5.906 0a1.874 1.874 0 1 1 0 3.749 1.874 1.874 0 0 1 0-3.749zM2 6.125a1.874 1.874 0 1 1 .001 3.749A1.874 1.874 0 0 1 2 6.125z"/>
});
            ...
            <React.Fragment>
                <Dropdown
                    ...
                    switcher={(
                        ...
                        >
                            &#8204;
                            <ButtonIcon><Icon name="dots" size="16" viewBoxSize="16"/></ButtonIcon>
                        </Button>
                    )}
                    popup={(
                        <Popup
