...
import {Icon, TextInput, YCSelect} from '@parma-data-ui/common/src';
            ...
            }
            {
                isDisplayElement && (
                    <div className={b('content-row')}>
                        ...
                        >
                            <RadioButton.Radio value={CalcModes.Formula}>
                                {i18n('value_formula')}
                            </RadioButton.Radio>
                            <RadioButton.Radio value={CalcModes.Direct}>
                                {i18n('value_source-from-field')}
                            </RadioButton.Radio>
                            <RadioButton.Radio value={CalcModes.Spel}>
                                {i18n('value_spel')}
                            </RadioButton.Radio>
                        </RadioButton>
                    </div>
            ...
            }
            {
                calcMode === CalcModes.Formula && (
                    <FormulaEditor
                        ...
                        modePath={modePath}
                        onChange={(formula) => modifyField({formula}, {
                            validate: true,
