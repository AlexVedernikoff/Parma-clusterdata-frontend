...
import {
    DATASET_JOIN_TYPE,
} from '../../../../../../src/containers/Dataset/dataset_join_type';
import {
    DATASET_ARRAY_JOIN_TYPE,
} from '../../../../../../src/containers/Dataset/dataset_array_join_type';
import Dataset
    from '../../../../../../src/containers/Dialogs/Control/Switchers/Dataset';
import DatasetField
    from '../../../../../../src/containers/Dialogs/Control/Switchers/DatasetField/DatasetField';
...
class FieldEditor extends React.Component {
    ...
    clearLinkedDataset = () => this.modifyField({
        linkedDataset: null,
        linkedField: null,
        joinType: null
    })
            ...
            <React.Fragment>
                ...
                <React.Fragment>
                    <Dataset
                        ...
                        onClick={linkedDataset => this.setState(
                            prevState => ({
                                field: {
                                    ...prevState.field,
    ...
    _renderSettingsSections() {
        ...
        return (
            <React.Fragment>
                ...
                {settingsSection === SettingsSectionTypes.Connection && this._renderConnection({
