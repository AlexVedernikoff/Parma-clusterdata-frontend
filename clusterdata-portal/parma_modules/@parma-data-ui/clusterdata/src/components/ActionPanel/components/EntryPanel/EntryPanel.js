...
class EntryPanel extends React.Component {
    ...
    setInnerRefBtnEntryContextMenu = ref => { this.btnEntryContextMenuRef = ref; };
        ...
        return (
            <div className={b()}>
                <div className={b('entry-title')}>
                    ...
                    <span className={b('entry-title-description')}>
                        {description}
                    </span>
                </div>
                <div className={b('entry-actions')}>
                    <Button
                        ...
                        title={
                            isFavorite ?
                                i18n('button_remove-favorite') :
                                i18n('button_add-favorite')
                        }
                        icon={
                            isFavorite ?
