...
import CloudFolderSelect from '@parma-data-ui/common/src/components/CloudFolderSelect/CloudFolderSelect';
            ...
            <CloudFolderSelect
                ...
                textEmptyListMessage={
                    this.state.cloudTree.length === 0
                        ? i18n('label_not-active-folders')
                        : i18n('label_not-found')
                }
            />
        );
    }
