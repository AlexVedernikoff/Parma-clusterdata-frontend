...
import EntryDialogues from '@parma-data-ui/common/src/components/EntryDialogues/EntryDialogues';
...
export const entryDialoguesNotify = (dialogName, errorDialogRef) =>
    ({message: title, type, error}) => { // eslint-disable-line no-unused-vars
