...
export default declMod({ suggest: true }, {
    block: 'textinput',
    ...
    _onSelectItem: function _onSelectItem(item, byKeyboard) {
        ...
        this.props.onChange && this.props.onChange(item.props.val, this.props, { source: 'suggest', byKeyboard: byKeyboard });
        this._setCarret();
        this._suggestHide();
        if (!byKeyboard) {
            this.preventShow = true;
            ...
            if (len) {
                ...
                if (this.props.updateOnEnter) {
                    ...
                    if (this.props.onChange) {
                        this.props.onChange(this.elems[currentItem].props.val, this.props, { source: 'suggest', itemIndex: currentItem });
                    }
                }
            }
        }
