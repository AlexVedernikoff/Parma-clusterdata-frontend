...
import "./../../button2/_view/button2_view_default.css";*/ // eslint-disable-line
...
export default decl({
    ...
    render: function render() {
        ...
        var arrowIconOptions = _extends({}, view === 'default' ? { glyph: 'carets-v' } : { type: 'arrow', direction: opened ? 'top' : 'bottom' }, {
            key: 'arrow',
