...
export default decl(Control, {
    ...
    content: function content(_ref4) {
        ...
        Children.forEach(children, function (child, i) {
            if (Icon.isIcon(child)) {
                ...
                if (!innerElems.length) {
                    content.push(hasIconFromContent ? React.createElement(
                        LinkInner,
                        { key: 'inner' },
                        innerElems
                    ) : innerElems);
        ...
        icon && content.unshift(React.createElement(LinkIcon, { key: 'icon-default', side: needSetSide ? 'left' : '',
            children: Icon.isIcon(icon) ? icon : React.createElement(Icon, icon) }));
        iconLeft && content.unshift(React.createElement(LinkIcon, { key: 'icon-side-left', side: needSetSide ? 'left' : '',
        ...
        if (text) {
            if (!innerElems.length) {
                ...
                content.push(hasIconFromFields ? React.createElement(
                    LinkInner,
                    { key: 'inner' },
                    innerElems
                ) : innerElems);
        ...
        iconRight && content.push(React.createElement(LinkIcon, { key: 'icon-side-right', side: needSetSide ? 'right' : '',
