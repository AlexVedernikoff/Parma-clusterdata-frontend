...
export default declMod({ switcher: 'button2' }, {
    block: 'dropdown2',
    _renderSwitcher: function _renderSwitcher(_ref) {
        ...
        var icon = void 0;
        if (hasTick) {
            icon = React.createElement(Icon, _extends({ key: 'arrow' }, _extends({}, view === 'default' ? { glyph: 'carets-v' } : { type: 'arrow', direction: opened ? 'top' : 'bottom' }), {
