...
export default decl(Control, {
  ...
  content: function content(_ref3) {
    ...
    return [leftLabel && React.createElement(TumblerOption, {
      key: 'leftLabel',
      side: 'left',
      checked: checked,
      onChange: onChange,
    ...
    }), React.createElement(TumblerBox, _extends({
      key: "box"
    }, {
      view: view,
      id: id,
    ...
    })), React.createElement(TumblerInput, _extends({
      key: "input"
    }, {
      id: id,
      name: name,
      ...
      onChange: onChange,
      attrs: controlAttrs
    })), rightLabel && React.createElement(TumblerOption, {
      key: 'rightLabel',
      side: 'right',
      checked: checked,
      onChange: onChange,
