...
import Bem, { declMod, bool2string } from '@parma-lego/i-bem-react';
...
export default declMod({ view: 'default' }, {
    ...
    content: function content(_ref2) {
        ...
        return [React.createElement(Bem, { key: 'plate', block: 'radio-button', elem: 'plate',
            attrs: { style: style } }), children];
    },
