...
export default declMod({ hiding: '*', target: 'anchor' }, {
    block: 'popup2',
    willInit: function willInit() {
        this.__base.apply(this, arguments);

        this._anchorParents = [];
        this._updateIsAnchorVisible = throttle(this._updateIsAnchorVisible, this.__self.UPDATE_TARGET_VISIBILITY_THROTTLING_INTERVAL);
