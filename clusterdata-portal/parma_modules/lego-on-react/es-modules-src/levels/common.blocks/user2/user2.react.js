...
export default decl({
    ...
    content: function content(_ref3) {
        ...
        var exitUrl = passportHost + '/passport?mode=embeddedauth&action=logout&yu=' + yu + '&uid=' + uid + '&retpath=' + retpathEncoded;
        ...
        actionsMenu = actionsMenu.filter(function (item) {
            if (item.action === 'plus') {
        ...
        return [React.createElement(UserAccount, {
            ...
            onClick: this.onCurrentAccountClick }), React.createElement(
            Link,
            {
                key: 'a11y-exit',
                theme: 'pseudo',
            ...
            React.createElement(
                ...
                hat && yaplus === false && React.createElement(UserHat, _extends({
                ...
                React.createElement(UserMenuFooter, { settingsUrl: settingsUrl, helpUrl: helpUrl, contentRegion: contentRegion })
            )
        )];
    },
    ...
    onCurrentAccountMouseOver: function onCurrentAccountMouseOver(e) {
        ...
        if (this._isClosed) {
            ...
            this._isBannerReady && this.setState({
                hatVisible: true,
                plusItemVisible: false
            });
        }
    ...
    propTypes: {
        ...
        actionsMenu: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.shape({
            action: PropTypes.string.isRequired
        }), PropTypes.shape({
            url: PropTypes.string.isRequired,
            text: PropTypes.string.isRequired
        })])),
        multiAuthMenu: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.shape({
            action: PropTypes.string.isRequired
        }), PropTypes.shape({
            url: PropTypes.string.isRequired,
            text: PropTypes.string.isRequired
