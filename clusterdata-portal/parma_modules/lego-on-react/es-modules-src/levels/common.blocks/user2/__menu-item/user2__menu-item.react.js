...
export default decl(MenuItem, {
    block: 'user2',
    elem: 'menu-item',
    mix: function mix(_ref) {
        var action = _ref.action;

        return [].concat(_toConsumableArray(this.__base.apply(this, arguments) || []), [{ block: 'menu', elem: 'item', mods: { type: 'link', hovered: bool2string(this.state.hovered) } }]);
    },
