  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@parma-data-ui': path.resolve('./kamatech_modules/@parma-data-ui/'),
        '@parma-lego': path.resolve('./kamatech_modules/@parma-lego/'),
        'lego-on-react': path.resolve('./kamatech_modules/lego-on-react/'),
        assets: path.resolve('./kamatech_modules/@parma-data-ui/clusterdata/src/assets/'),
        components: path.resolve('./kamatech_modules/@parma-data-ui/clusterdata/src/components/'),
        constants: path.resolve('./kamatech_modules/@parma-data-ui/clusterdata/src/constants/'),
        hoc: path.resolve('./kamatech_modules/@parma-data-ui/clusterdata/src/hoc/'),
        icons: path.resolve('./kamatech_modules/@parma-data-ui/clusterdata/src/icons/'),
        libs: path.resolve('./kamatech_modules/@parma-data-ui/clusterdata/src/libs/'),
        utils: path.resolve('./kamatech_modules/@parma-data-ui/clusterdata/src/utils/'),
