  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        assets: path.resolve('./kamatech_modules/@kamatech-data-ui/clusterdata/src/assets/'),
        components: path.resolve('./kamatech_modules/@kamatech-data-ui/clusterdata/src/components/'),
        constants: path.resolve('./kamatech_modules/@kamatech-data-ui/clusterdata/src/constants/'),
        hoc: path.resolve('./kamatech_modules/@kamatech-data-ui/clusterdata/src/hoc/'),
        icons: path.resolve('./kamatech_modules/@kamatech-data-ui/clusterdata/src/icons/'),
        libs: path.resolve('./kamatech_modules/@kamatech-data-ui/clusterdata/src/libs/'),
        utils: path.resolve('./kamatech_modules/@kamatech-data-ui/clusterdata/src/utils/'),
