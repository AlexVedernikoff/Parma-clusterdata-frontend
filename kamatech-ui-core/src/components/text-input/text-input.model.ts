...
export class TextInputModel implements TextInputInterface {
  constructor(value?: TextInputInterface) {
    ...
    this.theme = theme
    this.tone = tone
    this.type = type || TextInputModel.type
    this.view = view || TextInputModel.view
  }
