...
var I18N =
  ...
  (function() {
    function I18N() {
      ...
      this.data =
        ((_this$data = {}),
        (0, _defineProperty2['default'])(_this$data, I18N.LANGS.ru, {}),
        (0, _defineProperty2['default'])(_this$data, I18N.LANGS.en, {}),
        _this$data);
    }
      ...
      [
        {
          ...
          value: function registerKeyset(lang, keysetName) {
            ...
            this.data[lang] = Object.assign(
              {},
              this.data[lang],
              (0, _defineProperty2['default'])({}, keysetName, data),
            );
          },
        },
        {
          ...
          value: function i18n(keysetName, key, params) {
            ...
            if (typeof language === 'undefined') {
              throw new Error(
                "Language '".concat(
                  I18N.lang,
                  "' is not defined, make sure you call setLang for the same language you called registerKeysets for!",
                ),
              );
            }
