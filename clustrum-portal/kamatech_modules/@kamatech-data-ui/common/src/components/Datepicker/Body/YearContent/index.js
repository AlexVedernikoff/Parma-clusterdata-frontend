...
export default function YearContent(props) {
  ...
  const isYearTitleDisabled =
    dateHelpers.isDateOutOfRange(firstYearDay, minDate, maxDate) ||
    dateHelpers.isDateOutOfRange(lastYearDay, minDate, maxDate);

  return (
    <div className={b('chunk-year', { disabled: isYearTitleDisabled })} data-year={year}>
