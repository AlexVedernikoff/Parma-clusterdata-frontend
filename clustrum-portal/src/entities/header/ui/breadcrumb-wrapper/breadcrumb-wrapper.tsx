...
export function BreadcrumbWrapper({ leftSideContent, ...props }: HeaderProps): JSX.Element {
  ...
  return (
    <div className={'header__breadcrumb'}>
      ...
      <div className={'header__breadcrumb-title'}>
        ...
        {leftSideContent && (
          <div className={'header__breadcrumb-title-actions'}>
            {leftSideContent.map((actionBtn: object) => actionBtn)}
          </div>
        )}
      </div>
    </div>
